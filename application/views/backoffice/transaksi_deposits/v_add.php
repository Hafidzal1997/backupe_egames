                    ...
                    <div class="col-md-9">
                        <form action="<?php echo current_url();?>" method="post" class="form-horizontal form-label-left" enctype="multipart/form-data">
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-md-9 col-sm-9">
                                    <input type="text" class="form-control" id="kode_member" name="kode_member" value="<?php echo set_value('kode_member');?>">
                                    <?php echo form_error('kode_member', '<span class="text-danger">', '</span>');?>
                                </div>
                            </div>                            
                            <div class="form-group row ">
                                <label class="control-label col-md-3" for="jumlah_deposit">
                                    Jumlah Deposit
                                </label>
                                <div class="col-md-9 col-sm-9">
                                    <input type="number" class="form-control" id="jumlah_deposit" name="jumlah_deposit" value="<?php echo set_value('jumlah_deposit');?>">
                                    <?php echo form_error('jumlah_deposit', '<span class="text-danger">', '</span>');?>
                                </div>
                            </div>
                            <div class="form-group row ">
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-md-9 col-sm-9">
                                    ...
                                    <a href="<?php echo base_url('backoffice/transaksi-deposits');?>" class="btn btn-secondary">
