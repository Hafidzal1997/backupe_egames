                    ...
                    <div class="card">
                        ...
                        <div id="collapse-filter" class="collapse" aria-labelledby="heading-filter">
                            <div class="card-body border-bottom">
                                <form class="form-horizontal" id="form_filter" method="post" action="<?php echo base_url('backoffice/transaksi-deposits/export-excel');?>">
    ...
    $(document).ready(function() {
        ...
        */
        var dataTable = $('#MyTable').DataTable({
            ...
            "ajax":{
                url :"<?php echo base_url('backoffice/transaksi-deposits/deposits_json'); ?>",
                type: "POST",
                "data": function (data) {
        ...
        */
        $(document).on("click", ".btn-hapus-terpilih", function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url : "<?php echo base_url('backoffice/transaksi-deposits/delete_all');?>",
                        type: 'POST',
