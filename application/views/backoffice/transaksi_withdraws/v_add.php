                    ...
                    <div class="col-md-9">
                        <form action="<?php echo current_url();?>" method="post" class="form-horizontal form-label-left" enctype="multipart/form-data">
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-md-9 col-sm-9">
                                    <input type="number" class="form-control" id="jumlah_withdraw" name="jumlah_withdraw" value="<?php echo set_value('jumlah_withdraw');?>">
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-md-9 col-sm-9">
                                    ...
                                    <a href="<?php echo base_url('backoffice/transaksi-withdraws');?>" class="btn btn-secondary">
