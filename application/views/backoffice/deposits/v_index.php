                    ...
                    <div class="card">
                        ...
                        <div id="collapse-filter" class="collapse" aria-labelledby="heading-filter">
                            <div class="card-body border-bottom">
                                <form class="form-horizontal" id="form_filter" method="post" action="<?php echo base_url('backoffice/deposits/export-excel');?>">
        ...
        */
        $(document).on("click", ".btn-hapus-terpilih", function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url : "<?php echo base_url('backoffice/deposits/delete_all');?>",
                        type: 'POST',
