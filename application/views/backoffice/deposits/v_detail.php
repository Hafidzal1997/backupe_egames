...
<script>
    $("#MyModalDetailNotifikasiTitle").html('Detail Notifikasi Deposit');
     ...
     $(document).ready(function() {
        var url_edit    = '<?php echo base_url('backoffice/deposits/edit/' . encode($edit->id));?>';
        var url_accept  = '<?php echo base_url('backoffice/deposits/accept/' . encode($edit->id));?>';
        var url_reject  = '<?php echo base_url('backoffice/deposits/reject/' . encode($edit->id));?>';
        ...
        function append_data(){
            var get_url_detail_append = '<?php echo base_url('backoffice/deposits/detail-append/' . encode($edit->id));?>';
