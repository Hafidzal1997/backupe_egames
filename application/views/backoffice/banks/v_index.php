    ...
    <div class="col-md-12 col-sm-12">
        <div class="x_panel">
            <div class="x_content">
                ...
                <div class="form-group row">
                    <div class="col-md-12">
                        <a href="<?php echo base_url('backoffice/banks/add');?>" class="btn btn-dark" title="Tambah Data">
...
<script>
    $(document).ready(function() {
        ...
        var dataTable = $('#MyTable').DataTable({
            ...
            "ajax":{
                url :"<?php echo base_url('backoffice/banks/banks_json'); ?>",
                type: "POST",
                "data": function (data) {
        ...
        $(document).on("click", ".btn-hapus-terpilih", function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url : "<?php echo base_url('backoffice/banks/delete_all');?>",
                        type: 'POST',
