                        ...
                        <form action="<?php echo current_url();?>" method="post" class="form-horizontal form-label-left" enctype="multipart/form-data">
                            ...
                            <?php if($edit->flag_status == 'A'){?>
                                <div class="form-group row ">
                                    ...
                                    <div class="col-md-9 col-sm-9">
                                        ...
                                        <input type="hidden"  name="kode_member_prefixs" value="<?php echo (set_value('kode_member_prefixs') ? set_value('kode_member_prefixs') : $edit->kode_member_prefixs);?>">
                            ...
                            <?php } else { ?>
                                <div class="form-group row ">
                                    ...
                                    <div class="col-md-9 col-sm-9">
                                        <input type="text" class="form-control" id="kode_member" name="kode_member" value="<?php echo (set_value('kode_member') ? set_value('kode_member') : $edit->kode_member);?>" readonly>
                                        <input type="hidden"  name="kode_member_prefixs" value="<?php echo (set_value('kode_member_prefixs') ? set_value('kode_member_prefixs') : $edit->kode_member_prefixs);?>">
                                        <?php echo form_error('kode_member_prefixs', '<span class="text-danger">', '</span>');?>
                                        <strong class="text-primary">KODE MEMBER DAPAT DI UBAH KETIKA STATUSNYA ACCEPTED</strong>
                                    </div>
                                </div>
                            <?php } ?>
                                    ...
                                    <select name="clients_id" class="form-control">
                                        ...
                                        if($clients){
                                            foreach($clients as $row_clients){
                                                $selected = ((set_value('clients_id') ? set_value('clients_id') : $edit->clients_id) == $row_clients->id ? 'selected' : '');
                                                echo '<option value="'.$row_clients->id.'" '.$selected.'>'.$row_clients->nama_permainan.'</option>';
                                            }
                                        }
                                        ?>
                                    </select>
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-md-9 col-sm-9">
                                    <input type="text" class="form-control" id="nama_lengkap" name="nama_lengkap" value="<?php echo (set_value('nama_lengkap') ? set_value('nama_lengkap') : $edit->nama_lengkap);?>">
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-md-9 col-sm-9">
                                    <input type="number" class="form-control" id="no_hp" name="no_hp" value="<?php echo (set_value('no_hp') ? set_value('no_hp') : $edit->no_hp);?>">
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-md-9 col-sm-9">
                                    <input type="email" class="form-control" id="email" name="email" value="<?php echo (set_value('email') ? set_value('email') : $edit->email);?>">
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-md-9 col-sm-9">
                                    <input type="text" class="form-control" id="nomor_referral" name="nomor_referral" value="<?php echo (set_value('nomor_referral') ? set_value('nomor_referral') : $edit->nomor_referral);?>">
