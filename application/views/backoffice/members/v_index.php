                    ...
                    <div class="card">
                        ...
                        <div id="collapse-filter" class="collapse" aria-labelledby="heading-filter">
                            <div class="card-body border-bottom">
                                <form class="form-horizontal" id="form_filter" method="post" action="<?php echo base_url('backoffice/members/export-excel');?>">
                                    <div class="form-group row">
                                        <label class="control-label col-md-3 font-weight-bold">Client</label>
                                        <div class="col-md-5">
                                            <select id="clients_id" class="form-control">
                       ...
                       <table id="MyTable" class="table table-hover table-bordered table-striped dt-responsive nowrap jambo_table bulk_action" cellspacing="0" width="100%">
                           <thead>
                               <tr>
                                   ...
                                   <th>Kode Member</th>
                                   <th>Waktu Daftar</th>
                                   <th>Nama Member /<br>No. HP /<br>Email /<br>Nama Client</th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">
                    <i class="fa fa-power-off mr-2"></i> Tutup
                </button>
            </div>
        </div>
    </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        */
        var dataTable = $('#MyTable').DataTable({
            ...
            "columnDefs": [ 
                ...
                {"aTargets":[7], "width" : 70, "sClass": "text-right"},
            ...
            "ajax":{
                url :"<?php echo base_url('backoffice/members/members_json'); ?>",
                type: "POST",
                "data": function (data) {
        ...
        */
        ...
        |--------------------------------------------------------------------------
        */
        $(document).on("click", ".btn-detail-deposit",function() {
            $("#MyModal").modal('show');
            $("#MyModalTitle").html('Histori Deposit');
        ...
        |--------------------------------------------------------------------------
        */
        $(document).on("click", ".btn-detail-withdraw",function() {
            $("#MyModal").modal('show');
            $("#MyModalTitle").html('Histori Withdraw');
            $("#MyModalBody").html(progress_bar);
        ...
        */
        $(document).on("click", ".btn-hapus-terpilih", function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url : "<?php echo base_url('backoffice/members/delete_all');?>",
                        type: 'POST',
