<div class="accordion mb-3" id="accordion_modal">
    <div class="card">
        <div class="card-header bg-dark  px-3 py-2">                            
            <a role="tab" id="heading-filter-modal" data-toggle="collapse" data-parent="#accordion_modal" href="#collapse-filter-modal" aria-expanded="true" aria-controls="collapse-filter-modal">
                <h6 class="text-white">
                    <i class="fa fa-filter"></i> Filter Data
                </h6>
            </a>
        </div>
        <div id="collapse-filter-modal" class="collapse" aria-labelledby="heading-filter-modal">
            <div class="card-body border-bottom">
                <form class="form-horizontal" id="form_filter_modal" method="post" action="<?php echo base_url('backoffice/withdraws/export-excel');?>">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-5 col-sm-9">
                            <div class="row">
                                ...
                                <div class="col-5 col-sm-5">
                                    <div class="input-group date">
                                        <input onkeydown="event.preventDefault()" type="text" class="form-control" id="accepted_at_awal_modal" value="<?php echo date('01/m/Y');?>" disabled>
    ...
    $(document).ready(function() {
        ...
        */
        var dataTableModal = $('#MyTableModal').DataTable({
            ...
            "ajax":{
                url :"<?php echo base_url('backoffice/withdraws/withdraws_json'); ?>",
                type: "POST",
                "data": function (data) {
