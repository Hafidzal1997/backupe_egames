...
<script>
    ...
    $(document).ready(function() {
        var url_edit    = '<?php echo base_url('backoffice/withdraws/edit/' . encode($edit->id));?>';
        var url_accept  = '<?php echo base_url('backoffice/withdraws/accept/' . encode($edit->id));?>';
        var url_reject  = '<?php echo base_url('backoffice/withdraws/reject/' . encode($edit->id));?>';
        ...
        function append_data(){
            var get_url_detail_append = '<?php echo base_url('backoffice/withdraws/detail-append/' . encode($edit->id));?>';
