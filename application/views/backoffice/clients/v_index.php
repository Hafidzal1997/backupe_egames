    ...
    <div class="col-md-12 col-sm-12">
        <div class="x_panel">
            <div class="x_content">
                ...
                <div class="form-group row">
                    <div class="col-md-12">
                        <a href="<?php echo base_url('backoffice/clients/add');?>" class="btn btn-dark" title="Tambah Data">
    ...
    $(document).ready(function() {
        ...
        var dataTable = $('#MyTable').DataTable({
            ...
            "columnDefs": [ 
                ...
                {"aTargets":[2], "width" : 250,},
                {"aTargets":[4], "width" : 100, "sClass": "text-center"},
                {"aTargets":[5], "width" : 200, "sClass": "text-center"},
            ...
            "ajax":{
                url :"<?php echo base_url('backoffice/clients/clients_json'); ?>",
                type: "POST",
                "data": function (data) {
        ...
        $(document).on("click", ".btn-hapus-terpilih", function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url : "<?php echo base_url('backoffice/clients/delete_all');?>",
                        type: 'POST',
