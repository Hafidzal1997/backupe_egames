                    ...
                    <div class="col-md-9">
                        <form action="<?php echo current_url();?>" method="post" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                    ...
                                    <select id="permainans_categories_id" name="permainans_categories_id" class="form-control">
                                        ...
                                        if($kategori){
                                            foreach($kategori as $row){
                                                $selected = ($row->id == set_value('permainans_categories_id') ? 'selected' : '');
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-md-9 col-sm-9">
                                    <input type="text" class="form-control" id="nama_permainan" name="nama_permainan" value="<?php echo set_value('nama_permainan');?>">
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-md-9 col-sm-9">
                                    <textarea name="deskripsi_permainan" id="deskripsi_permainan" class="form-control" rows="5"><?php echo set_value('deskripsi_permainan');?></textarea>
