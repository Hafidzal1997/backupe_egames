    ...
    <div class="col-md-12 col-sm-12">
        <div class="x_panel">
            <div class="x_content">
                        ...
                        <select id="roles_id" class="form-control">
                            ...
                            if($roles){
                                foreach($roles as $row_roles){
                                    echo '<option value="'.$row_roles->id.'">'.$row_roles->roles.'</option>';
                                }
                            }
                            ?>
                        </select>
                ...
                <div class="form-group row">
                    <div class="col-md-12">
                        <a href="<?php echo base_url('backoffice/users/add');?>" class="btn btn-dark" title="Tambah Data">
    ...
    $(document).ready(function() {
        ...
        var dataTable = $('#MyTable').DataTable({
            ...
            "columnDefs": [ 
                ...
                {"aTargets":[2], "width" : 200},
                {"aTargets":[4], "width" : 150, "sClass": "text-center"},
                {"aTargets":[5], "width" : 70, "sClass": "text-center"},
                {"aTargets":[6], "width" : 70, "sClass": "text-center"},
            ...
            "ajax":{
                url :"<?php echo base_url('backoffice/users/users_json'); ?>",
                type: "POST",
                "data": function (data) {
        ...
        var select_all = document.getElementById("posting_all"); //select all checkbox
        var checkboxes = document.getElementsByClassName("posting"); //checkbox items
        ...
        $(document).on("change", "#roles_id", function() {
            dataTable.ajax.reload();
        });
        ...
        $(document).on("click", ".btn-hapus-terpilih", function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url : "<?php echo base_url('backoffice/users/delete_all');?>",
                        type: 'POST',
