                        ...
                        <form action="<?php echo current_url();?>" method="post" class="form-horizontal form-label-left" enctype="multipart/form-data">
                            <div class="form-group row ">
                                ...
                                <div class="col-md-9 col-sm-9">
                                    <input type="text" class="form-control" name="nama_kategori_permainan" value="<?php echo (set_value('nama_kategori_permainan') ? set_value('nama_kategori_permainan') : $edit->nama_kategori_permainan);?>">
