    ...
    <div class="col-md-12 col-sm-12">
        <div class="x_panel">
            <div class="x_content">
                ...
                <div class="form-group row">
                    <div class="col-md-12">
                        <a href="<?php echo base_url('backoffice/permainans-categories/add');?>" class="btn btn-dark" title="Tambah Data">
    ...
    $(document).ready(function() {
        ...
        var dataTable = $('#MyTable').DataTable({
            ...
            "columnDefs": [ 
                ...
                {"aTargets":[4], "width" : 70, "sClass": "text-center"},
            ...
            "ajax":{
                url :"<?php echo base_url('backoffice/permainans-categories/permainans-categories-json'); ?>",
                type: "POST",
                "data": function (data) {
        ...
        $(document).on("click", ".btn-hapus-terpilih", function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url : "<?php echo base_url('backoffice/permainans-categories/delete_all');?>",
                        type: 'POST',
